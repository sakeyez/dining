...
import com.sake.friendly_mob_npc.zombie_warrior.WarriorNPCRenderer;
import com.sake.friendly_mob_npc.wither_warrior.WitherWarriorNPCRenderer;
...
@Mod.EventBusSubscriber(modid = "friendly_mob_npc", value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.MOD)
public class NpcClientEventSubscriber {

    public static final ModelLayerLocation WARRIOR_NPC_LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("friendly_mob_npc", "warrior_npc"), "main");
    public static final ModelLayerLocation WARRIOR_INNER_ARMOR_LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("friendly_mob_npc", "warrior_npc_inner_armor"), "main");
    public static final ModelLayerLocation WARRIOR_OUTER_ARMOR_LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("friendly_mob_npc", "warrior_npc_outer_armor"), "main");

    // 凋零骷髅战士只需要盔甲层，主体模型我们用原版的
    public static final ModelLayerLocation WITHER_WARRIOR_INNER_ARMOR_LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("friendly_mob_npc", "wither_warrior_npc_inner_armor"), "main");
    public static final ModelLayerLocation WITHER_WARRIOR_OUTER_ARMOR_LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("friendly_mob_npc", "wither_warrior_npc_outer_armor"), "main");
