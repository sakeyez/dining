...
import net.minecraft.world.damagesource.DamageTypes; // 【修复】导入正确的类
...
public class WitherWarriorNPCEntity extends TamableAnimal {
    ...
    static {
        Stream.of(
                "kaleidoscope_cookery:dark_cuisine", "kaleidoscope_cookery:suspicious_stir_fry",
                "kaleidoscope_cookery:slime_ball_meal", "kaleidoscope_cookery:fondant_pie",
                "kaleidoscope_cookery:dongpo_pork", "kaleidoscope_cookery:fondant_spider_eye",
                "kaleidoscope_cookery:chorus_fried_egg", "kaleidoscope_cookery:braised_fish",
                "kaleidoscope_cookery:golden_salad", "kaleidoscope_cookery:spicy_chicken",
                "kaleidoscope_cookery:yakitori", "kaleidoscope_cookery:pan_seared_knight_steak",
                "kaleidoscope_cookery:stargazy_pie", "kaleidoscope_cookery:sweet_and_sour_ender_pearls",
                "kaleidoscope_cookery:crystal_lamb_chop", "kaleidoscope_cookery:blaze_lamb_chop",
                "kaleidoscope_cookery:frost_lamb_chop", "kaleidoscope_cookery:nether_style_sashimi",
                "kaleidoscope_cookery:end_style_sashimi", "kaleidoscope_cookery:desert_style_sashimi",
                "kaleidoscope_cookery:tundra_style_sashimi", "kaleidoscope_cookery:cold_style_sashimi",
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (heldItem.getItem() instanceof WitherWarriorSummonItem) return InteractionResult.PASS;
    ...
    public boolean hurt(DamageSource pSource, float pAmount) {
        ...
        double r = switch(getLevel()){case 2->0.2;case 3->0.4;default->0.0;};
